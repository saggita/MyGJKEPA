...
CreateFunc* createFuncs[] = {
	...
	SSShadowMapDemo::createFunc,

//	ShallowWaterEqn1DDemo::createFunc,
	AdlPrimitivesDemo::createFunc,
	PositionBasedParticleDemo::createFunc,
	DeformableDemo::createFunc,
//	PathTraceDemo::createFunc,
	CPUBandwidthDemo::createFunc,
};
