...
typename RadixSortStandard<type>::Data* RadixSortStandard<type>::allocate(const Device* deviceData, int maxSize, Option option)
{
	...
	data->m_localSortKernel = KernelManager::query( deviceData, PATH, KERNEL0, 0, 0 );
	data->m_scatterKernel = KernelManager::query( deviceData, PATH, KERNEL1, 0, 0 );
	data->m_copyKernel = KernelManager::query( deviceData, PATH, KERNEL2, 0, 0 );
