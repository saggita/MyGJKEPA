...
//void CustomConvexConvexPairCollision::processCollisionCL(const ContactPoint4& contactsOut, btCollisionObject* body0,btCollisionObject* body1,const btDispatcherInfo& dispatchInfo,btManifoldResult* resultOut)
//{
//#if 1
//	if (!m_manifoldPtr)
//	{
