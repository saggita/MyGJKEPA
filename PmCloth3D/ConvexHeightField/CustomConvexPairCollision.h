...
class CustomConvexConvexPairCollision : public btConvexConvexAlgorithm
{
	...
	//void processCollisionCL(const ContactPoint4& contactsOut, btCollisionObject* body0,btCollisionObject* body1,const btDispatcherInfo& dispatchInfo,btManifoldResult* resultOut);
